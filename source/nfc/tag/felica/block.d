...
unittest{
	//block number
	assert(Block(0).pack == [0b10000000, 0b0]);
	assert(Block(511).pack == [0b0, 0b11111111, 0b1]);
	//service code number
	assert(Block(0, 1).pack == [0b10000001, 0b0]);
	assert(Block(0, 15).pack == [0b10001111, 0b0]);
	//access mode
	assert(Block(0, 0, 1).pack == [0b10010000, 0b0]);
}
